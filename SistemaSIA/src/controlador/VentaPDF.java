...
public class VentaPDF {
    ...
    public void DatosCliente(int idCliente) {
        ...
        String sql = "select * from MAE_CLIENTE where idCliente = '" + idCliente + "'";
        Statement st;
        try {
    ...
    public void generarFacturaPDF() {
        try {
            ...
            String nombre = "Mcdonals";
            String telefono = "913066846";
            String direccion = "Arequipa";
            String razon = "Grupo Facturas";
